...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'ionicons',get_template_directory_uri() . '/inc/assets/fonts/ionicons.min.css' );
    wp_enqueue_style( 'ionicons1',get_template_directory_uri() . '/inc/assets/css/Bold-BS4-Cards-with-Hover-Effect-50-1.css' );
    wp_enqueue_style( 'ionicons2',get_template_directory_uri() . '/inc/assets/css/Bold-BS4-Cards-with-Hover-Effect-50.css' );
    wp_enqueue_style( 'ionicons3',get_template_directory_uri() . '/inc/assets/css/Carousel-Hero.css' );
    wp_enqueue_style( 'ionicons4',get_template_directory_uri() . '/inc/assets/css/Contact-FormModal-Contact-Form-with-Google-Map.css' );
    wp_enqueue_style( 'ionicons5',get_template_directory_uri() . '/inc/assets/css/Dark-NavBar.css' );
    wp_enqueue_style( 'ionicons6',get_template_directory_uri() . '/inc/assets/css/Features-Boxed-Remixed-1.css' );
    wp_enqueue_style( 'ionicons7',get_template_directory_uri() . '/inc/assets/css/Features-Boxed-Remixed-2.css' );
    wp_enqueue_style( 'ionicons8',get_template_directory_uri() . '/inc/assets/css/Features-Boxed-Remixed-3.css' );
    wp_enqueue_style( 'ionicons9',get_template_directory_uri() . '/inc/assets/css/Features-Boxed-Remixed.css' );
    wp_enqueue_style( 'ionicons0',get_template_directory_uri() . '/inc/assets/css/Footer-Dark.css' );
    wp_enqueue_style( 'ionicons11',get_template_directory_uri() . '/inc/assets/css/Navigation-with-Button.css' );
    wp_enqueue_style( 'ionicons12',get_template_directory_uri() . '/inc/assets/css/Search-Input-responsive.css' );
    wp_enqueue_style( 'ionicons13',get_template_directory_uri() . '/inc/assets/css/styles.css' );
    wp_enqueue_style( 'ionicons14',get_template_directory_uri() . '/inc/assets/css/WOWSlider-about-us-1.css' );
    wp_enqueue_style( 'ionicons15',get_template_directory_uri() . '/inc/assets/css/WOWSlider-about-us-2.css' );
    wp_enqueue_style( 'ionicons16',get_template_directory_uri() . '/inc/assets/css/WOWSlider-about-us.css' );

    wp_enqueue_style( 'ionicons17',get_template_directory_uri() . '/inc/assets/css/News-Cards.css' );
    ...
    wp_enqueue_script('ionicons13',get_template_directory_uri() . '/inc/assets/js/Contact-FormModal-Contact-Form-with-Google-Map.js', '', '', true );
    wp_enqueue_script( 'ionicons14',get_template_directory_uri() . '/inc/assets/js/WOWSlider-about-us.js', '', '', true );
    wp_enqueue_script( 'ionicons15',get_template_directory_uri() . '/inc/assets/js/jquery.min.js', '', '', true );
